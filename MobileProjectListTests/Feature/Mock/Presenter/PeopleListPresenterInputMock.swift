...
final class PeopleListPresenterInputMock: PeopleListPresenterInput {
    ...
    var invokedShowParameters: (list: [Person], Void)?
    var invokedShowParametersList = [(list: [Person], Void)]()
